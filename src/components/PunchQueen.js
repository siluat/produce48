...
class PunchQueen extends Component {
  ...
  render() {
    ...
    const { traineeData, maxPoint, isLoading } = this.state;
    ...
    return (
      <div>
        ...
        />
        <Menu icon="labeled" attached widths={1}>
          <Menu.Item
            as="a"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="134" height="22">
              <defs>
                <linearGradient
                  ...
                  y2="-1.735%"
                >
                  <stop offset="0%" stopColor="#00DE7B" />
                  <stop offset="100%" stopColor="#00BA6E" />
                </linearGradient>
              </defs>
              <g fill="none" fillRule="evenodd">
                <g fillRule="nonzero" transform="translate(-2 -2)">
                  <path fill="url(#a)" d="M2 4.96h5.78V21.1H2z" />
                  <rect
                    width="5.78"
                    height="21.08"
                    x="8.498"
                    ...
                    fill="#00DE7B"
                    rx="2.89"
                    transform="rotate(58 11.388 17.05)"
                  />
                  <rect
                    width="5.79"
                    height="21.116"

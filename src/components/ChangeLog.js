...
const ChangeLog = () =>
  <div>
    ...
    <Segment attached>
      <List bulleted>
        <List.Item>콘셉트 평가 영상 순위 추가</List.Item>
        <List.Item>주요 음원 차트의 콘셉트 평가곡 실시간 순위 추가</List.Item>
      </List>
    </Segment>
    <Header as='h2' attached='top'>
      2018-08-15
    ...
    <Segment attached>
      <List bulleted>
        <List.Item>콘셉트 평가 엔딩 요정 영상 순위 추가</List.Item>
      </List>
    </Segment>
    <Header as='h2' attached='top'>
      2018-08-13

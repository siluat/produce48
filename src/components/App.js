            ...
            <div ref={this.handleContextRef}>
              <Sticky context={contextRef} className="top-menu">
                <Menu attached inverted>
                  <Dropdown style={{ width: '68%' }} item text="Menu">
                    <Dropdown.Menu>
              ...
              <Switch>
                ...
                <Route
                  ...
                  path="/punchQueen"
                  render={(props) => (
                    <PunchQueen {...props} i18n={i18n} t={t} />
                  )}
                />
                <Route
                  exact
                ...
                <Route
                  ...
                  path="/conceptMusic"
                  render={(props) => (
                    <ConceptMusicRanking {...props} i18n={i18n} t={t} />
                  )}
                />
                <Route
                  exact
                  path="/conceptEnding"
                  render={(props) => (
                    <ConceptEndingRanking {...props} i18n={i18n} t={t} />
                  )}
                />
                <Route
                  exact
                  path="/verticalCam"
                  render={(props) => (
                    <VerticalCamRanking {...props} i18n={i18n} t={t} />
                  )}
                />
                <Route
                  exact
                  path="/special"
                  render={(props) => (
                    <SpecialClipRanking {...props} i18n={i18n} t={t} />
                  )}
                />
                <Route
                  exact
                  path="/position"
                  render={(props) => (
                    <PositionDirectCamRanking {...props} i18n={i18n} t={t} />
                  )}
                />
                <Route
                  exact
                ...
                <Route
                  ...
                  path="/nekkoya"
                  render={(props) => (
                    <NekkoyaDirectCamRanking {...props} i18n={i18n} t={t} />
                  )}
                />
                <Route
                  exaxt
